...
data_inicio = st.date_input("Data de Início do desenvolvimento", value=datetime.date(2025, 4, 1))
...
media_espera = st.slider("Tempo Médio de Espera (dias)", 0, 30, 15)
desvio_espera = st.slider("Desvio Padrão da Espera (dias)", 0, 10, 5)
